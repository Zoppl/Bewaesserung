...
void handleRoot()
{
  ...
  <body>\
    <h1>Garten Bewaesserungsanlage</h1>";
...
//   <iframe style="display:none" name="hidden-form"></iframe>
  ...
  message = message + "<h2>Bewaesserungplaene</h2><table><tr><th>Bodensensor</th><th>Ventil</th><th>Zielfeuchte</th><th>Bodenf.</th><th>LW</th></tr>";
...
void loop(void)
{
  ...
  if (currentMillis - millisLastDisplayUpdate >= 1000)
  {
    ...
    for (uint8_t i = 0; i < VALVE_COUNT; i++)
    {
      tft.setCursor(tft.width() * 0.7, 10 + i * 10);
      tft.print("V");
      tft.print(i+1);
      tft.print(": ");
  ...
  if (currentMillis - millisLastGraphUpdate >= 1000 * 60 * 4)  // *15   4 and 16 below to draw a red line every hour
  {
